...
import com.idat.EC3JesusRafaelReservaCita.service.UsuarioClienteService;
...
public class UsuarioClienteController {
	...
	public ResponseEntity<Void> guardar(@RequestBody UsuarioClienteDTORequest productos) {
		service.guardarUsuarioClientel(productos);
	...
	public ResponseEntity<Void> actualizar(@RequestBody UsuarioClienteDTORequest productos) {
		UsuarioClienteDTOResponse p =service.obtenerUsuarioClienteId(productos.getIdUsuario());
		if(p != null) {
			service.actualizarUsuarioCliente(productos);
			return  new ResponseEntity<Void>(HttpStatus.OK);
		}
		return  new ResponseEntity<Void>(HttpStatus.NOT_FOUND);
	}
